  ...
  return (
    <div className={cx(s.wrap, className)}>
      ...
      <div className={s.avatar}>
        <img alt="avatar" src="https://instagram.frix2-1.fna.fbcdn.net/v/t51.2885-19/s320x320/13402406_532985290225422_964375496_a.jpg?tp=1&_nc_ht=instagram.frix2-1.fna.fbcdn.net&_nc_ohc=ZbeNAYkBDDYAX--F-Zq&edm=ABfd0MgBAAAA&ccb=7-4&oh=f48711a5ef878c043056bebf48ffc55c&oe=60BF2509&_nc_sid=7bff83" />
      </div>
